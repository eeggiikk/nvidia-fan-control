...
От исходной версии отличается ограничением размера лога, гистерезис работает только при снижении температуры, в конфигурацию вынесен параметр критической температуры, при которой все процессы в видеокарте убивается наглухо.
